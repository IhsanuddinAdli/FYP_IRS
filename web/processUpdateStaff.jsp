        ...
        <div class="container mt-5">
            ...
            <%
                ...
                if (request.getMethod().equalsIgnoreCase("post")) {
                    ...
                    String updateQuery = "UPDATE staff SET firstname=?, lastname=?, email=?, phone=?, password=? WHERE userID=?";
                    try {
                        ...
                        updateStmt.setString(6, staffID);
            ...
            <form action="processUpdateStaff.jsp" method="post">
                ...
                <button type="button" class="btn btn-secondary" onclick="window.location.href='staffList.jsp'">Back</button>
            </form>
        </div>
