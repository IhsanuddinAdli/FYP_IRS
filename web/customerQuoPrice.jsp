...
<html>
    <head>
        ...
        <title>Quotation Price Page</title>
        <!-- Bootstrap CSS -->
        ...
        <div class="wrapper">
            ...
            <div id="content">
                ...
                <div id="main-content-image">
                    <div class="container">
                        <!-- Display calculated insurance prices -->
                        <div class="row">
                            <div class="col-md-12">
                                <h3 class="text-center">Insurance Prices</h3>
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        <!-- Display insurance prices dynamically using server-side logic -->
                                        <%
                                            // Sample insurance prices (replace with actual logic)
                                            String[] companies = {"Takaful Ikhlas", "Takaful Malaysia", "Pacific", "Allianz", "Liberty", "Generali", "Etiqa", "Zurich"};
                                            double[] prices = {500.00, 550.00, 600.00, 650.00, 700.00, 750.00, 800.00, 850.00};
                        ...
                        <!-- End of displaying insurance prices -->
                    </div>
                </div>
                <!-- Main Content end -->
