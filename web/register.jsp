        ...
        <div class="register-div">
            ...
            <form class="form" id="form" action="processRegister.jsp" method="post">
                ...
                <div class="phoneNum">
                    ...
                    <input type="text" name="phone" id="phone" placeholder="Phone Number" onkeypress="return validateNumber(event)" maxlength="12" required>
                </div>
                ...
                <div class="password">
                    ...
                    <input type="password" name="password" id="password" placeholder="Password" required oninput="checkPasswordLength()">
                </div>
